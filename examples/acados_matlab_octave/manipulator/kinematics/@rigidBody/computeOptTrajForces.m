function [Lambda, xddot, x] = computeOptTrajForces(obj, t)
...
Aeq = zeros(22,34);
Aeq(1:6, 1:16) = obj.G*obj.Fc_hat;
Aeq(1:6, 17:22) = -eye(6)*Kp*dt^2 -eye(6)*Kd*dt;
Aeq(1:6, 23:28) = zeros(6,6);

Aeq(7:12, 1:16) = zeros(6,6);
Aeq(7:12, 17:22) = -0.5*eye(6)*dt;
Aeq(7:12, 23:28) = eye(6);

Beq = [C + Kp*eye(6)*v*dt; -x - v*dt - t];
