...
oee0 = [0,0,0]; %initial euler zyx of ee wrt world
oee1 = [0,0,0]; % euler zyx final
...
for i = 1 : size(tSteps,2)
    ...
    pd_shifted(i, 1:3) = (zyx2R(o_wb(i,1:3))'*pd(i, 1:3)')';
    w_des_shifted(1:3, i) = (zyx2R(o_wb(i,1:3))'*w_des(1:3,i));
end
%% circular trajectory 
